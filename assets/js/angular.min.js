    ...
    function (O, U, t) {
        ...
        function J(b) {
            return function () {
                ...
                c = "[" + (
                        b ? b + ":" : ""
                    ) + a + "] http://errors.angularjs.org/1.4.3/" + (
                        b ? b + "/" : ""
                    ) + a;
            ...
            if (b) {
                if (z(b)) {
                    for (d in b) {
                        ...
                        b.hasOwnProperty && !b.hasOwnProperty(d) || a.call(c, b[d], d, b);
                    }
                } else if (G(b) || Ea(b)) {
            ...
            for (var d = b.$$hashKey, e = 0, f = a.length; e < f; ++e) {
                ...
                if (H(g) || z(g)) {
                    for (var h = Object.keys(g), l = 0, k = h.length; l < k; l++) {
                        var n = h[l], r = g[n];
                        c && H(r) ? aa(r) ? b[n] = new Date(r.valueOf()) : (
                            H(b[n]) ||
                            (
                                b[n] = G(r) ? [] : {}
                            ), Nb(b[n], [r], !0)
        ...
        function fa(b, a, c, d) {
            ...
            if (a) {
                ...
                if (uc.test(sa.call(b))) {
                    a = new b.constructor(b);
                } else if (aa(b)) {
                    a
                        = new Date(b.getTime());
                } else if (Za(b)) {
                    a = new RegExp(b.source,
                                   b.toString().match(/[^\/]*$/)[0]), a.lastIndex
                        = b.lastIndex;
                } else {
                    return e =
        ...
        function Xd(b, a) {
            var c = a;
            "string" === typeof b && "$" === b.charAt(0) && "$" === b.charAt(1) ? c = t : Wa(a) ? c = "$WINDOW" :
                                                                                          a && U === a ?
                                                                                          c = "$DOCUMENT" : $a(a) && (
                                                                                              c = "$SCOPE"
                                                                                          );
        ...
        function zc(b) {
            ...
            m((
              b || ""
                ...
                b && (
                    c = b.replace(/\+/g,
                                  "%20").split("="), d = yc(c[0]), w(d) && (
                        b = w(c[1]) ? yc(c[1]) : !0, Xa.call(a, d) ? G(a[d]) ? a[d].push(b) : a[d] = [a[d], b] :
                                                     a[d] = b
                    )
                )
            });
        ...
        function Zd(b, a) {
            ...
            m(Oa, function (a) {
                a += "app";
                !c && b.hasAttribute && b.hasAttribute(a) && (
            ...
            c && (
                e.strictDi = null !== Yd(c, "strict-di"), a(c, d ? [d] : [], e)
            )
        }
                    ...
                    y = la, P(la.fn, {
                        ...
                        if (Rb) {
                            ...
                            for (
                                ...
                                (
                                    d = la._data(f, "events")
                                ) && d.$destroy && la(f).triggerHandler("$destroy");
                            }
                        }
                        b(a)
                    }
        ...
        function Pc(b, a, c, d) {
            ...
            if (f) {
                if (a) {
                    ...
                    for (a in e) {
                        "$destroy" !== a && b.removeEventListener(a,
                                                                  f, !1), delete e[a]
                    }
                }
            }
        ...
        function ub(b, a) {
            ...
            d && (
                a ? delete d.data[a] : (
                    d.handle && (
                        d.events.$destroy && d.handle({}, "$destroy"), Pc(b)
                    ), delete ib[c], b.ng339 = t
                )
            )
        }
        ...
        function Ga(b, a) {
            ...
            c = typeof b;
            return c = "function" == c || "object" == c && null !== b ? b.$$hashKey = c + ":" + (
                a || Ud
                )() : c + ":" + b
        }
        ...
        function Hf(b) {
            return (
                       b = b.toString().replace(Vc, "").match(Wc)
                   ) ? "function(" + (
            b[1] || ""
            ).replace(/[\s\r\n]+/, " ") + ")" : "fn"
        }
                ...
                m(a, function (a) {
                    ...
                    if (!n.get(a)) {
                        ...
                        try {
                            L(a) ? (
                                c = gb(a), b
                                    = b.concat(g(c.requires)).concat(c._runBlocks), d(c._invokeQueue), d(c._configBlocks)
                            ) : z(a) ? b.push(s.invoke(a)) : G(a) ?
                ...
                "$window", "$location", "$rootScope", function (a, c, d) {
                    ...
                    function f(b) {
                        if (b) {
                            ...
                            c = g.yOffset;
                            z(c) ? c = c() : tc(c) ? (
                                c = c[0], c = "fixed" !== a.getComputedStyle(c).position ? 0 :
                                              c.getBoundingClientRect().bottom
                            ) : V(c) || (
                                c = 0
                            );
                            c && (
                                b = b.getBoundingClientRect().top, a.scrollBy(0, b - c)
                            )
                        } else {
                            a.scrollTo(0,
                                       0)
            ...
            l.url = function (a, c, e) {
                ...
                if (a) {
                    ...
                    if (!d.history || h && f) {
                        if (!h || I)I = a;
                        c ? k.replace(a) : h ? (
                            c = k, e = a.indexOf("#"), a = -1 === e ? "" : a.substr(e), c.hash = a
                        ) : k.href = a
                    } else {
                        n[c ? "replaceState" : "pushState"](e, "", a), g(), p = u;
                    }
                    return l
                }
                return I ||
                ...
                function b(b, d) {
                    function e(a) {
                        a != r && (
                            s ? s == a && (
                                s = a.n
                            ) : s = a, f(a.n, a.p), f(a, r), r = a, r.n = null
                        )
                    }
                    ...
                    var g                   = 0, h = P({}, d, {id: b}), l = {}, k = d && d.capacity ||
                        Number.MAX_VALUE, n = {}, r = null, s = null;
                    return a[b] = {
                        put:          function (a, b) {
                            if (!A(b)) {
        ...
        function Ec(b, a) {
            ...
            this.directive = function s(a, f) {
                Ra(a, "directive");
                L(a) ? (
                    d(a), Sb(f, "directiveFactory"), e.hasOwnProperty(a) || (
                        e[a] = [], b.factory(a + "Directive", [
                            "$injector", "$exceptionHandler", function (b, d) {
                                ...
                                m(e[a], function (e, g) {
                                    try {
                                        var h = b.invoke(e);
                                        z(h) ? h = {compile: ra(h)} : !h.compile && h.link && (
                                            h.compile = ra(h.link)
                                        );
                                        ...
                                        H(l.scope) && (
                                            !0 === l.bindToController ? (
                                                n.bindToController = c(l.scope, s, !0), n.isolateScope = {}
                                        ...
                                        var q = k.$$bindings = n;
                                        H(q.isolateScope) && (
                                            h.$$isolateBindings = q.isolateScope
                                        );
            ...
            this.$get = [
                "$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller",
                ...
                function (a, b, c, d, u, p, K, q, I, B, N) {
                    ...
                    function Z(a, b, c, d, e) {
                        ...
                        m(a, function (b, c) {
                            b.nodeType == Na && b.nodeValue.match(/\S+/) && (
                        ...
                        return function (b, c, d) {
                            ...
                            g || (
                                g = (
                                        d = d && d[0]
                                    ) ? "foreignobject" !== ta(d) && d.toString().match(/SVG/) ? "svg" : "html" : "html"
                            );
                    ...
                    function S(a, b, c, d, e, f) {
                        function g(a,
                            ...
                            for (n = h.length; s < n;) {
                                if (k = C[h[s++]], c = h[s++], f = h[s++], c) {
                                    if (c.scope) {
                                        if (l = a.$new(), Z.$$addScopeInfo(y(k), l), B
                                                = c.$$destroyBindings) {
                                    ...
                                    B = c.transcludeOnThisElement ? $(a, c.transclude, e) :
                                        !c.templateOnThisElement && e ? e : !e && b ? $(a, b) : null;
                                    c(f, l, k, d, B, c)
                                } else {
                        ...
                        for (var h = [], k, l, s, n, p, B = 0; B < a.length; B++) {
                            ...
                            ) && f.scope && Z.$$addScopeClass(k.$$element);
                            k = f && f.terminal || !(
                                s = a[B].childNodes
                            ) || !s.length ? null : S(s, f ? (
                        ...
                        switch (a.nodeType) {
                            case qa:
                                ...
                                for (var l, s, n, p = a.attributes, B = 0, C = p && p.length; B < C; B++) {
                                    ...
                                    l = wa(k);
                                    if (n = ia.test(l)) {
                                        k = k.replace(Zc, "").substr(8).replace(/_(.)/g,
                                                                                function (a, b) {
                                    ...
                                    A(F) && l === F + "Start" && (
                                        x = k, S = k.substr(0, k.length - 5) + "end", k = k.substr(0, k.length - 6)
                                    );
                                    l = wa(k.toLowerCase());
                                    h[l] = k;
                            ...
                            case Na:
                                if (11 === Ua) {
                                    for (
                                        ; a.parentNode && a.nextSibling && a.nextSibling.nodeType === Na;
                                    ) {
                    ...
                    function E(a, b, d, e, f, g, h, k, s) {
                        ...
                        function S(a, c, e, f, g, l) {
                            ...
                            g && (
                                ha = s, ha.$$boundTransclude = g
                            );
                            N && (
                                m = x(ja, f, ha, N, F, c)
                            );
                            u && (
                                Z.$$addScopeInfo(ja, F, !0, !(
                                D && (
                                D === u || D === u.$$originalDirective
                                )
                                )), Z.$$addScopeClass(ja, !0), F.$$isolateBindings = u.$$isolateBindings, W(c, f, F,
                                                                                                            F.$$isolateBindings,
                                                                                                            u, F)
                            );
                            if (m) {
                                ...
                                for (n in m) {
                                    ...
                                    var E = C();
                                    E !== C.instance && (
                                        C.instance = E, ja.data("$" + n + "Controller", E), C === I && (
                                            l.$$destroyBindings(), l.$$destroyBindings = W(c, f, E, p, K)
                                        )
                                    )
                                }
                            }
                            ...
                            for (l = h.length; n < l; n++) {
                                p = h[n], Y(p, p.isolateScope ? F : c, ja, f,
                                            p.require && B(p.directiveName, p.require, ja, m),
                                            ha);
                            }
                            var va = c;
                            u && (
                            u.template || null === u.templateUrl
                            ) && (
                                va = F
                            );
                            a && a(va,
                            ...
                            for (n = k.length - 1; 0 <= n; n--) {
                                p = k[n], Y(p, p.isolateScope ? F : c, ja, f,
                                            p.require &&
                                            B(p.directiveName, p.require, ja, m), ha)
                            }
                        }

                        s = s || {};
                        for (
                            var F = -Number.MAX_VALUE, $ = s.newScopeDirective, N = s.controllerDirectives, u = s.newIsolateScopeDirective, D = s.templateDirective, m = s.nonTlbTranscludeDirective, K = !1, I = !1, q = s.hasElementTranscludeDirective, ba = d.$$element
                                = y(b), E, w, v, A = e, Aa, xa = 0, Ta = a.length; xa < Ta; xa++
                        ) {
                            E = a[xa];
                            ...
                            w = E.name;
                            !E.templateUrl && E.controller && (
                                v = E.controller, N = N || ga(), O("'" + w + "' controller", N[w], E, ba), N[w] = E
                            );
                            if (v = E.transclude) {
                                K = !0, E.$$tlb || (
                                    O("transclusion", m, E, ba), m = E
                                ), "element" == v ? (
                                    q = !0, F = E.priority, v = ba, ba = d.$$element = y(U.createComment(" " + w +
                                                                                                         ": " +
                                                                                                         d[w] + " ")), b
                                        = ba[0], T(f, za.call(v, 0), b), A = Z(v, e, F, g && g.name,
                            ...
                            if (E.template) {
                                if (I = !0, O("template",
                                              D, E, ba), D = E, v = z(E.template) ? E.template(ba, d) :
                            ...
                            if (E.templateUrl) {
                                I = !0, O("template", D, E, ba), D = E, E.replace && (
                                    g = E
                            ...
                            E.terminal && (
                                S.terminal = !0, F = Math.max(F, E.priority)
                            )
                        }
                        S.scope = $ && !0 === $.scope;
                    ...
                    function A(b) {
                        if (e.hasOwnProperty(b)) {
                            for (
                                var c = a.get(b + "Directive"), d = 0, f = c.length; d < f; d++
                            ) {
                    ...
                    function J(a, b) {
                        ...
                        m(b, function (b, f) {
                            ...
                            f ? (
                                ...
                                e.attr("style", e.attr("style") + ";" + b), a.style = (
                                        a.style ? a.style + ";" : ""
                                    ) + b
                        ...
                        d(x).then(function (d) {
                            ...
                            for (n = S(b[0].childNodes, f); l.length;) {
                                ...
                                if (!d.$$destroyed) {
                                    if (u !== p) {
                                        var Z = u.className;
                                        k.hasElementTranscludeDirective && B.replace || (
                                            K = Vb(F)
                                        );
                                        T(I, y(u), K);
                                        D(y(K), Z)
                    ...
                    function Q(a, b) {
                        ...
                        var c = ta(a);
                        if ("xlinkHref" == b || "form" == c && "action" == b || "img" != c && (
                                "src" == b ||
                                "ngSrc" == b
                            )) {
                    ...
                    function T(a, b, c) {
                        ...
                        a.appendChild(d);
                        y.hasData(d) && (
                            y(c).data(y(d).data()), la ? (
                                Rb = !0, la.cleanData([d])
                            ) : delete y.cache[d[y.expando]]
                        );
                        d = 1;
                        ...
                        m(e, function (e, g) {
                            ...
                            switch (s) {
                                ...
                                case "=":
                                    ...
                                    l = function (b) {
                                        C(b, d[g]) || (
                                            C(b, n) ? B(a, b = d[g]) : d[g] = b
                                        );
                                        return n = b
                                    };
                                    l.$stateful = !0;
                                    l = e.collection ? a.$watchCollection(c[k], l) :
                    ...
                    aa.prototype = {
                        $normalize:      wa, $addClass: function (a) {
                            ...
                            (
                                c = bd(b, a)
                            ) && c.length && B.removeClass(this.$$element, c)
                            ...
                            if ("a" === g && "href" === a || "img" === g && "src" === a) {
                                ...
                                g && "srcset" === a) {
                                for (
                                    var g = "", h = R(b), k = /(\s+\d+x\s*,|\s+\d+w\s*,|\s+,|,\s+)/, k = /\s/.test(h) ?
                                                                                                         k :
                                                                                                         /(,)/, h = h.split(k), k = Math.floor(h.length /
                                                                                                                                               2), l = 0;
                                    l < k; l++
                                ) {
                                    var s = 2 * l, g = g + N(R(h[s]), !0), g = g + (
                                            " " + R(h[s + 1])
                                        );
                                }
                                h       = R(h[2 * l]).split(/\s/);
                            ...
                            !1 !== d && (
                                null === b || b === t ? this.$$element.removeAttr(e) : this.$$element.attr(e, b)
                            );
                            (
                                a = this.$$observers
                            ) && m(a[f],
                ...
                "$injector", "$window", function (c, d) {
                    ...
                    return function (f, g, h, l) {
                        ...
                        if (L(f)) {
                            ...
                            n = l[1];
                            r = r || l[3];
                            f = b.hasOwnProperty(n) ? b[n] : Dc(g.$scope, n, !0) || (
                                a ? Dc(d, n, !0) : t
                            );
                            Qa(f,
                               n, !0)
                        ...
                        if (h) {
                            return h = (
                                G(f) ? f[f.length - 1] : f
                            ).prototype, k = Object.create(h || null), r && e(g, r, k, n || f.name), P(function () {
        ...
        function bf() {
            var b = this.defaults = {
                ...
                transformRequest:  [
                    function (a) {
                        return H(a) && "[object File]" !== sa.call(a) && "[object Blob]" !== sa.call(a) &&
                               "[object FormData]" !== sa.call(a) ? db(a) : a
                    }
                ],
                headers:           {
                ...
                function (d, e, f, g, h, l) {
                    function k(a) {
                        ...
                        var f = [
                            function (a) {
                                ...
                                A(a.withCredentials) && !A(b.withCredentials) && (
                    ...
                    function n(c, f) {
                        ...
                        function n(a, b, d, e) {
                            ...
                            )({data: a, status: b, headers: ed(d), config: c, statusText: e})
                        }
                        ...
                        var I = h.defer(), B = I.promise, N, D, q = c.headers, S = r(c.url,
                                                                                     c.paramSerializer(c.params));
                        k.pendingRequests.push(c);
                        B.then(m, m);
                        !c.cache && !b.cache || !1 === c.cache || "GET" !== c.method && "JSONP" !== c.method || (
                            N = H(c.cache) ? c.cache : H(b.cache) ? b.cache : s
                        );
                        N && (
                            D = N.get(S), w(D) ? D && z(D.then) ? D.then(x, x) :
                                                 G(D) ? n(D[1], D[0], ia(D[2]), D[3]) : n(D, 200, {}, "OK") :
                                          N.put(S, B)
                        );
                        A(D) && (
                            (
                            ...
                            ), d(c.method, S, f, l, q, c.timeout, c.withCredentials, c.responseType)
                        );
                        return B
                    }
        ...
        function Sf(b, a, c, d, e) {
            ...
            return function (e, h, l, k, n, r, s, x) {
                ...
                if ("jsonp" == M(e)) {
                    ...
                    K.onload = function () {
                        var a = K.statusText || "", b = "response"in K ? K.response : K.responseText, c = 1223 ===
                                                                                                          K.status ?
                                                                                                          204 :
                                                                                                          K.status;
                        0 === c && (
                            c = b ? 200 : "file" == Ba(h).protocol ? 404 : 0
                        );
        ...
        function $e() {
            ...
            this.$get = [
                "$parse", "$exceptionHandler", "$sce", function (c, d, e) {
                    ...
                    function h(f, h, n, r) {
                        ...
                        for (
                            ...
                            if (-1 != (
                                ...
                                q !== p && D.push(g(f.substring(q, p))), q = f.substring(p + l,
                                                                                         m), I.push(q), B.push(c(q,
                                                                                                                 u)), q
                                    = m + k, t.push(D.length), D.push("");
                            } else {
                    ...
                    var l = b.length, k = a.length, n = new RegExp(b.replace(/./g, f),
                                                                   "g"), r = new RegExp(a.replace(/./g, f), "g");
        ...
        function af() {
            this.$get = [
                "$rootScope", "$window", "$q", "$$q", function (b, a, c, d) {
                    function e(e, h, l, k) {
                        var n = 4 < arguments.length, r = n ? za.call(arguments, 4) :
                                                          [], s = a.setInterval, x = a.clearInterval,
                            C = 0, F = w(k) && !k, u = (
                                F ? d : c
                            ).defer(), p = u.promise;
                        l = w(l) ? l : 0;
            ...
            this.html5Mode = function (b) {
                return ab(b) ? (
                    ...
                    ab(b.requireBase) && (
                        ...
                        a.rewriteLinks = b.rewriteLinks
                    ), this
                ) : a
            };
            this.$get = [
                "$rootScope", "$browser", "$sniffer", "$rootElement", "$window", function (c, d, e, f, g) {
                    function h(a, b, c) {
                    ...
                    f.on("click", function (b) {
                        if (a.rewriteLinks && !b.ctrlKey && !b.metaKey && !b.shiftKey && 2 != b.which &&
                            ...
                            H(h) && "[object SVGAnimatedString]" === h.toString() && (
                                h = Ba(h.animVal).href
                            );
                            x.test(h) || !h || e.attr("target") || b.isDefaultPrevented() || !k.$$parseLinkUrl(h, l) ||
                            (
                    ...
                    c.$watch(function () {
                        var a                  =
                                Bb(d.url()), b = Bb(k.absUrl()), f = d.state(), g = k.$$replace, n = a !== b ||
                            k.$$html5 && e.history && f !== k.$$state;
                        if (C || n) {
                            C = !1, c.$evalAsync(function () {
                                ...
                                k.absUrl() === b && (
                                    d ? (
                                        ...
                                        n && h(b, g, f === k.$$state ? null : k.$$state), l(a, f)
                                    )
                                )
                            });
                        }
        ...
        function Ca(b, a) {
            if ("__defineGetter__" === b || "__defineSetter__" === b || "__lookupGetter__" === b ||
                "__lookupSetter__" === b || "__proto__" === b) {
                throw da("isecfld", a);
            }
            return b
        }
        ...
        function T(b, a) {
            ...
            switch (b.type) {
                ...
                case q.MemberExpression:
                    ...
                    b.constant = b.object.constant && (
                        !b.computed || b.property.constant
                        );
                    b.toWatch = [b];
                    break;
        ...
        function pd(b) {
            if (1 ===
                b.body.length && od(b.body[0].expression)) {
                return {
        ...
        function qd(b) {
            return 0 === b.body.length || 1 === b.body.length && (
                b.body[0].expression.type === q.Literal || b.body[0].expression.type === q.ArrayExpression ||
            ...
            this.$get = [
                "$filter", "$sniffer", function (c, d) {
                    ...
                    function k(a, b) {
                        ...
                        f ? c.$$watchDelegate = a.$$watchDelegate : b.$stateful || (
                            ...
                            case "string":
                                ...
                                m || (
                                    ":" === d.charAt(0) && ":" === d.charAt(1) && (
                                        u = !0, d = d.substring(2)
                                    ), C = C ? r : n, m = new gc(C), m = (
                                        new hc(m, c, C)
                                    ).parse(d), m.constant ? m.$$watchDelegate = l :
                                                u ? m.$$watchDelegate = m.literal ? h : g : m.inputs && (
                                                    m.$$watchDelegate = f
                                                ), q[p] = m
                                );
                                return k(m,
            ...
            this.$get = [
                "$window", "$timeout", function (b, a) {
                    ...
                    var e                                                                      = b.requestAnimationFrame ||
                        b.webkitRequestAnimationFrame, f                                       = b.cancelAnimationFrame ||
                        b.webkitCancelAnimationFrame || b.webkitCancelRequestAnimationFrame, g = !!e, h = g ?
                                                                                                          function (a) {
                                                                                                              var b = e(a);
                                                                                                              return function () {
                                                                                                                  f(b)
        ...
        function jf() {
            ...
            this.$get = [
                "$injector", "$exceptionHandler", "$parse", "$browser", function (f, g, h, l) {
                    function k(a) {
                    ...
                    n.prototype = {
                        constructor:         n, $new: function (a, c) {
                            ...
                            do {
                                ...
                                a:do {
                                            ...
                                            try {
                                                if (b = k[n]) {
                                                    if ((
                                                            ...
                                                            b.eq ? ka(f, h) :
                                                            "number" === typeof f && "number" === typeof h &&
                                                            isNaN(f) &&
                                                            isNaN(h)
                                                        )) {
                                                        s = !0, d = b, b.last = b.eq ? fa(f, null) : f, b.fn(f,
                                                                                                             h === q ?
                                                                                                             f :
                                                                                                             h,
                                                                                                             x), 5 >
                                                        m && (
                                                            E = 4 - m, u[E] || (
                                                                ...
                                                                msg:               z(b.exp) ? "fn: " + (
                                                                    b.exp.name || b.exp.toString()
                                                                ) : b.exp, newVal: f, oldVal: h
                                                            })
                                                        );
                                                    } else if (b === d) {
                                                        s = !1;
                                    ...
                                    if (!(
                                            k = x.$$watchersCount && x.$$childHead || x !== this && x.$$nextSibling
                                        )) {
                                        for (
                                            ; x !==
                                              this && !(
                        ...
                        $evalAsync:          function (a, b) {
                            ...
                            for (var f = cb([e], arguments, 1), h, k; c = d;) {
                                ...
                                if (!(
                                        d = c.$$listenerCount[a] && c.$$childHead || c !== this && c.$$nextSibling
                                    )) {
                                    for (
                                        ; c !== this && !(
                                        d =
        ...
        function mf() {
            ...
            this.$get = [
                "$parse", "$sceDelegate", function (a, c) {
            ...
            this.$get = [
                "$window", "$document", function (b, a) {
                    var c = {}, d = W((
                        ...
                        {}, g, h = /^(Moz|webkit|ms)(?=[A-Z])/, l = f.body && f.body.style, k = !1, n = !1;
                    if (l) {
                        for (var r in l) {
                            if (k = h.exec(r)) {
                                g = k[0];
                        ...
                        g || (
                            g = "WebkitOpacity"in l && "webkit"
                        );
                        k = !!(
                        "transition"in l || g + "Transition"in l
                        );
                        n = !!(
                        "animation"in l || g + "Animation"in l
                        );
                        !d || k && n || (
                    ...
                    return {
                        history:     !(
                        !b.history || !b.history.pushState || 4 > d || e
                        ), hasEvent: function (a) {
                            if ("input" ===
                                a && 11 >= Ua) {
                                return !1;
        ...
        function rf() {
            this.$get = [
                "$rootScope", "$browser", "$location", function (b, a, c) {
                    return {
                        findBindings:   function (a, b, c) {
                            ...
                            m(a, function (a) {
                                ...
                                d && m(d, function (d) {
                                    c ? (
                                        new RegExp("(^|\\s)" + ud(b) + "(\\s|\\||$)")
                                    ).test(d) && g.push(a) : -1 != d.indexOf(b) && g.push(a)
                                })
                            });
                            return g
                            ...
                            for (var g = ["ng-", "data-ng-", "ng\\:"], h = 0; h < g.length; ++h) {
                                var l = a.querySelectorAll("[" + g[h] + "model" + (
                                                               c ? "=" : "*="
                                                           ) + '"' + b + '"]');
            ...
            this.$get = [
                "$rootScope", "$browser", "$q", "$$q", "$exceptionHandler", function (b, a, c, d, e) {
                    function f(f, l, k) {
                        ...
                        var n = za.call(arguments, 3), r = w(k) && !k, s = (
                                r ? d : c
                            ).defer(),
                            m = s.promise, q;
                        q = a.defer(function () {
        ...
        function Cd(b, a, c, d, e) {
            ...
            if (g || k) {
                ...
                A(e) && (
                    e = Math.min(Math.max(a.minFrac, g), a.maxFrac)
                );
                b              = +(
                    Math.round(+(
                        b.toString() + "e" + e
                ...
                var g          = (
                    "" + b
                ).split(Dd), h = g[0], g = g[1] || "", r = 0, s = a.lgSize, m = a.gSize;
                if (h.length >= s + m) {
        ...
        function zd(b) {
            ...
            return function (c, e, f) {
                ...
                f && (
                    n = xc(f, c.getTimezoneOffset()), c = Pb(c, f, !0)
                );
                m(h, function (a) {
                    l = hg[a];
        ...
        function lb(b, a, c, d) {
            return function (e, f, g, h, l, k, n) {
                ...
                h.$parsers.push(function (b) {
                    return h.$isEmpty(b) ? null : a.test(b) ? (
                        b = c(b, q), m && (
                            b = Pb(b, m)
                        ), b
                    ) : t
        ...
        var Pa = Q.prototype = {
            ready:       function (b) {
                ...
                var c = !1;
                "complete" === U.readyState ? setTimeout(a) : (
            ...
            removeData:     ub, on: function a(c, d, e, f) {
                ...
                if (Mc(c)) {
                    ...
                    for (var g = 0 <= d.indexOf(" ") ? d.split(" ") : [d], l = g.length; l--;) {
                        ...
                        var k = f[d];
                        k || (
                            f[d] = [], "mouseenter" === d || "mouseleave" ===
                            d ? a(c, lg[d], function (a) {
                                var c = a.relatedTarget;
                                c && (
                                c === this || this.contains(c)
                                ) || h(a, d)
                ...
                if (h = (
                    ...
                    e = {
                        ...
                        e = P(e, c)
                    ), c = ia(h), f = d ? [e].concat(d) : [e], m(c, function (c) {
        ...
        var Nd = J("$animate"), Ue = function () {
            ...
            var a = new Sa, c = [];
            this.$get = [
                "$$AnimateRunner", "$rootScope", function (d, e) {
                    function f(d, f, l) {
                        var k = a.get(d);
                        k || (
                            a.put(d, k = {}), c.push(d)
                    ...
                    "$$animateQueue", function (a) {
                        function c(a, d, e) {
                            if (e) {
                                ...
                                !l || l.parentNode || l.previousElementSibling || (
                                    e = null
                                )
                            }
        ...
        var og = /^([^\?#]*)(\?([^#]*))?(#(.*))?$/, Tf = {http: 80, https: 443, ftp: 21}, Cb = J("$location"), pg = {
            $$html5:     !1, $$replace: !1, absUrl: Db("$$absUrl"), url: function (a) {
                ...
                (
                c[1] || "" === a
                ) && this.path(decodeURIComponent(c[1]));
                (
                c[2] || c[1] || "" === a
                ) && this.search(c[3] || "");
                this.hash(c[5] || "");
        ...
        gc.prototype = {
            constructor:      gc, lex: function (a) {
                ...
                for (var a = "", c = this.index; this.index < this.text.length;) {
                    ...
                    if ("." == d || this.isNumber(d)) {
                        ...
                        if ("e" == d && this.isExpOperator(e)) {
                            ...
                            this.isNumber(e) && "e" == a.charAt(a.length - 1)) {
                            a += d;
                ...
                for (var d = "", e = a, f = !1; this.index < this.text.length;) {
                    ...
                    if (f) {
                        "u" === g ? (
                            f = this.text.substring(this.index + 1, this.index + 5), f.match(/[\da-f]{4}/i) ||
                            this.throwError("Invalid unicode escape [\\u" + f + "]"), this.index += 4, d
        ...
        q.prototype = {
            ...
            ternary:             function () {
                ...
                return this.expect("?") && (
                    c = this.expression(), this.consume(":")
                ) ?
                       (
                           d = this.expression(), {type: q.ConditionalExpression, test: a, alternate: c, consequent: d}
                       ) : a
            },
            logicalOR:           function () {
            ...
            object:              function () {
                ...
                if ("}" !== this.peekToken().text) {
                    do {
                        ...
                        this.peek().constant ? c.key = this.constant() :
                        this.peek().identifier ? c.key = this.identifier() :
        ...
        rd.prototype = {
            compile:                    function (a, c) {
                ...
                this.stage = "assign";
                if (g = pd(e)) {
                    this.state.computing = "assign", f = this.nextId(), this.recurse(g, f), f = "fn.assign=" +
                ...
                f = (
                    new Function("$filter", "ensureSafeMemberName", "ensureSafeObject", "ensureSafeFunction",
                                 "ifDefined", "plus", "text", f)
            ...
            generateFunction:           function (a, c) {
                ...
                if (!g && w(a.watchId)) {
                    c = c || this.nextId(), this.if_("i",
                                                     this.lazyAssign(c, this.computedMember("i",
                                                                                            a.watchId)),
                                                     this.lazyRecurse(a, c, d, e, f,
                                                                      !0));
                } else {
                    switch (a.type) {
                        case q.Program:
                        ...
                        case q.BinaryExpression:
                            ...
                            r = "+" === a.operator ? this.plus(h, l) :
                                "-" === a.operator ? this.ifDefined(h, 0) + a.operator + this.ifDefined(l, 0) :
                                "(" + h + ")" + a.operator + "(" + l + ")";
                            this.assign(c, r);
                            e(r);
                            break;
                        ...
                        case q.Identifier:
                            c = c || this.nextId();
                            d && (
                                d.context = "inputs" === k.stage ? "s" : this.assign(this.nextId(),
                            ...
                            k.if_("inputs" === k.stage || k.not(k.getHasOwnProperty("l", a.name)), function () {
                                k.if_("inputs" === k.stage || "s", function () {
                                    f && 1 !== f && k.if_(k.not(k.nonComputedMember("s", a.name)),
                                    ...
                                    k.assign(c, k.nonComputedMember("s", a.name))
                                                                        ...
                                                                        a.name)));
                            (
                                k.state.expensiveChecks || Fb(a.name)
                            ) && k.addEnsureSafeObject(c);
                            e(c);
                            break;
                        case q.MemberExpression:
                            h = d && (
                                    d.context = this.nextId()
                                ) || this.nextId();
                            c = c || this.nextId();
                            k.recurse(a.object, h, t, function () {
                                k.if_(k.notNull(h), function () {
                                    if (a.computed) {
                                        l = k.nextId(), k.recurse(a.property,
                                                                  l), k.addEnsureSafeMemberName(l), f &&
                                        1 !== f &&
                                        k.if_(k.not(k.computedMember(h, l)),
                                              k.lazyAssign(k.computedMember(h, l), "{}")), r
                                            = k.ensureSafeObject(k.computedMember(h, l)), k.assign(c, r), d && (
                                            d.computed = !0, d.name = l
                                        );
                                    } else {
                                        Ca(a.property.name);
                                        f && 1 !== f && k.if_(k.not(k.nonComputedMember(h, a.property.name)),
                                                              k.lazyAssign(k.nonComputedMember(h, a.property.name),
                                                                           "{}"));
                        ...
                        case q.CallExpression:
                            c = c || this.nextId();
                            a.filter ? (
                                l = k.filter(a.callee.name), n = [], m(a.arguments, function (a) {
                                    var c = k.nextId();
                                    k.recurse(a, c);
                                    n.push(c)
                                }), r = l +
                                    "(" + n.join(",") + ")", k.assign(c, r), e(c)
                            ) : (
                                l = k.nextId(), h = {}, n = [], k.recurse(a.callee, l, h, function () {
                                    k.if_(k.notNull(l), function () {
                                        ...
                                        h.name ? (
                                            k.state.expensiveChecks || k.addEnsureSafeObject(h.context), r
                                                = k.member(h.context, h.name, h.computed) + "(" + n.join(",") + ")"
                                        ) : r = l + "(" + n.join(",") + ")";
                        ...
                        case q.ObjectExpression:
                            ...
                            m(a.properties, function (a) {
                                k.recurse(a.value,
                                        ...
                                        n.push(k.escape(a.key.type === q.Identifier ? a.key.name : "" + a.key.value) +
                                               ":" +
                                               c)
                                    })
                            });
        ...
        sd.prototype = {
            compile:              function (a, c) {
                ...
                switch (a.type) {
                    ...
                    case q.BinaryExpression:
                        return e = this.recurse(a.left), f = this.recurse(a.right), this["binary" + a.operator](e, f,
                                                                                                                c);
                    case q.LogicalExpression:
                        return e = this.recurse(a.left), f = this.recurse(a.right), this["binary" + a.operator](e, f,
                                                                                                                c);
                    case q.ConditionalExpression:
                        return this["ternary?:"](this.recurse(a.test), this.recurse(a.alternate),
                                                 this.recurse(a.consequent), c);
                    case q.Identifier:
                        return Ca(a.name, g.expression), g.identifier(a.name, g.expensiveChecks || Fb(a.name),
                                                                      c, d, g.expression);
                    case q.MemberExpression:
                        return e = this.recurse(a.object, !1, !!d), a.computed || (
                            Ca(a.property.name, g.expression), f = a.property.name
                        ), a.computed && (
                            f = this.recurse(a.property)
                        ), a.computed ? this.computedMember(e, f, c, d, g.expression) :
                           this.nonComputedMember(e, f, g.expensiveChecks, c, d, g.expression);
                    case q.CallExpression:
                        return h = [], m(a.arguments, function (a) {
                            h.push(g.recurse(a))
                        }), a.filter && (
                            f = this.$filter(a.callee.name)
                        ), a.filter || (
                            f = this.recurse(a.callee, !0)
                ...
                return function (g, h, l, k) {
                    var n = a(g, h, l, k), m, s;
                    null != n && (
                        m = c(g, h, l, k), Ca(m, f), e && 1 !== e && n && !n[m] && (
                            n[m] = {}
                        ), s = n[m], oa(s, f)
                    );
            ...
            sb[c] = function () {
                return {
                    priority: 99, link: function (d, e, f) {
                        var g = a, h = a;
                        "href" === a && "[object SVGAnimatedString]" === sa.call(e.prop("href")) && (
                            h = "xlinkHref", f.$attr[h] = "xlink:href",
                                g = null
                        );
        ...
        var Od     = function (a) {
                            ...
                            name: "form", restrict: a ? "EAC" : "E", controller: Gd, compile: function (d, e) {
                                ...
                                return {
                                    pre: function (a, d, e, k) {
                                        ...
                                        var m = k.$$parentForm;
                                        f && (
                                            Eb(a, k.$name, k, k.$name), e.$observe(f, function (c) {
                                                k.$name !== c && (
                                                    Eb(a, k.$name, t, k.$name), m.$$renameControl(k, c), Eb(a, k.$name,
                                                                                                            k, k.$name)
                                                )
                                            })
                                        );
            ...
            Sd     = /^(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, Td = {
                ...
                "datetime-local": lb("datetimelocal", Qd, Kb(Qd, "yyyy MM dd HH mm ss sss".split(" ")),
                ...
                week:             lb("week", mc, function (a, c) {
                    ...
                    if (L(a)) {
                        ...
                        var d = mc.exec(a);
                        if (d) {
                            var e = +d[1], f = +d[2], g = d = 0, h = 0, l = 0, k = Ed(e), f = 7 * (
                                f - 1
                                );
                            c && (
                                d = c.getHours(), g =
                ...
                checkbox:         function (a, c, d, e, f, g, h, l) {
                    var k = Jd(l, a, "ngTrueValue", d.ngTrueValue, !0), n = Jd(l, a, "ngFalseValue", d.ngFalseValue,
                                                                               !1);
                    c.on("click", function (a) {
                ...
                "$browser", "$sniffer", "$filter", "$parse", function (a, c, d, e) {
                    return {
                ...
                "$interpolate", "$compile", function (a, c) {
                    return {
                        compile: function (d) {
                            c.$$addBindingClass(d);
        ...
        var ye     = [
                ...
                "$templateRequest", "$anchorScroll", "$animate", function (a, c, d) {
                    return {
                        restrict:   "ECA",
                        priority:   400,
                        terminal:   !0,
                                ...
                                e.$watch(g, function (g) {
                                    ...
                                    g ? (
                                        a(g, !0).then(function (a) {
                                            ...
                                            r === t && (
                                                v(), e.$emit("$includeContentError", g)
                                            )
                    ...
                    return {
                        restrict: "ECA", priority: -400, require: "ngInclude", link: function (c, d, e, f) {
                            /SVG/.test(d[0].toString()) ? (
                                d.empty(), a(Nc(f.template, U).childNodes)(c, function (a) {
                                                                               d.append(a)
                                                                           },
            ...
            }, mb  = "ng-valid", Kd = "ng-invalid", Va = "ng-pristine", Jb = "ng-dirty", Md = "ng-pending", Lb = new J("ngModel"), wg = [
                "$scope", "$exceptionHandler", "$attrs", "$element", "$parse", "$animate", "$timeout", "$rootScope",
                "$q", "$interpolate", function (a, c, d, e, f, g, h, l, k, n) {
                    ...
                    this.$validate = function () {
                        if (!V(p.$modelValue) || !isNaN(p.$modelValue)) {
                            var a = p.$$rawModelValue, c = p.$valid, d = p.$modelValue, e = p.$options &&
                                p.$options.allowInvalid;
                            p.$$runValidators(a, p.$$lastCommittedViewValue, function (f) {
                                e || c === f || (
                                    p.$modelValue = f ? a : t, p.$modelValue !== d && p.$$writeModelToScope()
                                )
                            })
                        }
                    };
                    ...
                    this.$commitViewValue = function () {
                        var a = p.$viewValue;
                        h.cancel(F);
                        if (p.$$lastCommittedViewValue !== a ||
                            "" === a && p.$$hasNativeValidators)p.$$lastCommittedViewValue = a, p.$pristine &&
                    ...
                    this.$$parseAndValidate = function () {
                        ...
                        V(p.$modelValue) && isNaN(p.$modelValue) && (
                            p.$modelValue = q(a)
                        );
                        ...
                        p.$$runValidators(c, p.$$lastCommittedViewValue, function (a) {
                            f || (
                                p.$modelValue = a ? c : t, p.$modelValue !== e && p.$$writeModelToScope()
                            )
                        })
                    };
                    ...
                    this.$$debounceViewValueCommit = function (c) {
                        var d = 0, e = p.$options;
                        e && w(e.debounce) && (
                            e = e.debounce, V(e) ? d = e : V(e[c]) ? d = e[c] : V(e["default"]) && (
                                d = e["default"]
                            )
                        );
                        h.cancel(F);
                    ...
                    a.$watch(function () {
                        ...
                        if (c !== p.$modelValue && (
                            ...
                            p.$viewValue !== f && (
                                p.$viewValue = p.$$lastCommittedViewValue = f, p.$render(), p.$$runValidators(c, f, v)
                            )
                        }
                        return c
                    })
                            ...
                            return {
                                pre:     function (a, c, f, g) {
                                    ...
                                    e.on("blur", function (e) {
                                        h.$touched || (
                                            a.$$phase ? c.$evalAsync(h.$setTouched) : c.$apply(h.$setTouched)
                                        )
                                    })
                                }
                            }
                ...
                return {
                    restrict: "A", controller: [
                        "$scope", "$attrs", function (a, c) {
                            var d = this;
                            this.$options = fa(a.$eval(c.ngModelOptions));
                            this.$options.updateOn !== t ? (
                                this.$options.updateOnDefault = !1, this.$options.updateOn
                                    = R(this.$options.updateOn.replace(xg, function () {
            ...
            Je     = [
                    ...
                    function d(a, d, e) {
                        ...
                        var v = a && c(a) || d, u = t && c(t), p = t ? function (a, c) {
                            ...
                            return Ga(a)
                                          ...
                                          c) {
                            return p(a, z(a, c))
                        }, y  = c(m[2] || m[1]), A = c(m[3] || ""), B = c(m[4] || ""), N = c(m[8]), D = {}, z = q ?
                                                                                                                function (a,
                                                                                                                          c) {
                                                                                                                    D[q]
                                                                                                                        = c;
                        ...
                        return {
                            trackBy:        t, getTrackByValue: w, getWatchables: c(N, function (a) {
                                ...
                                for (var a = [], c = {}, d = N(e) || [], g = n(d), h = g.length, m = 0; m < h; m++) {
                                    var r = d === g ? m : g[m], s =
                                        z(d[r], r), q = v(e, s), r = p(q, s), u = y(e, s), x = A(e, s), s = B(e,
                                                                                                              s), q = new f(r,
                                                                                                                            q,
                                                                                                                            u,
                                                                                                                            x,
                        ...
                        restrict: "A", terminal: !0, require: ["select", "?ngModel"], link: function (c, h, l, k) {
                            ...
                            function t() {
                                ...
                                D.items.forEach(function (a) {
                                    ...
                                    a.group ? (
                                        g = c[a.group], g || (
                                            g = r(h[0], d, "optgroup", f), d =
                                                g.nextSibling, g.label = a.group, g = c[a.group] = {
                                                groupElement:         g,
                                                currentOptionElement: g.firstChild
                                            }
                                        ), k = r(g.groupElement, g.currentOptionElement, "option", e), n(a,
                                                                                                         k), g.currentOptionElement
                                            = k.nextSibling
                                    ) : (
                                        k = r(h[0], d, "option", e), n(a, k), d = k.nextSibling
                                    )
                                });
                                ...
                                k ? (
                                    ...
                                    u.writeValue = function (a) {
                                        ...
                                        c && !c.disabled ? h[0].value !== c.selectValue && (
                                            N.remove(), B || p.remove(), h[0].value = c.selectValue, c.element.selected
                                                = !0, c.element.setAttribute("selected", "selected")
                                        ) : null === a || B ? (
                                            N.remove(), B || h.prepend(p), h.val(""), p.prop("selected",
                                                                                             !0), p.attr("selected", !0)
                                        ) : (
                                                B || p.remove(), h.prepend(N), h.val("?"), N.prop("selected",
                                                                                                  !0), N.attr("selected",
                                                                                                              !0)
                                            )
                                    }, u.readValue = function () {
                                        ...
                                        return a && !a.disabled ?
                                               (
                                                   B || p.remove(), N.remove(), D.getViewValueFromOption(a)
                                               ) : null
                ...
                "$locale", "$interpolate", "$log", function (a, c, d) {
                    ...
                    return {
                        link: function (g, h, l) {
                            ...
                            var n     = l.count, r = l.$attr.when && h.attr(l.$attr.when), s = l.offset ||
                                0, q  = g.$eval(r) || {}, t =
                            ...
                            g.$watch(n, function (c) {
                                ...
                                e === z || f && V(z) && isNaN(z) || (
                                    y(), f = t[e], A(f) ? (
                                        null != c && d.debug("ngPluralize: no rule defined for '" + e + "' in " + r), y
                                            = v, k()
                                    ) : y = g.$watch(f, k), z = e
                                )
                            })
                    ...
                    return {
                        ...
                        compile:      function (f, g) {
                            ...
                            if (s && (
                                ...
                                /^(null|undefined|this|\$index|\$first|\$middle|\$last|\$even|\$odd|\$parent|\$root|\$id)$/.test(s)
                                ))throw d("badident", s);
                            var u, p, z, A, I = {$id: Ga};
                            q ? u = a(q) : (
                                z = function (a, c) {
                            ...
                            return function (a, f, g, k, n) {
                                ...
                                a.$watchCollection(r, function (g) {
                                    ...
                                    if (Ea(g))M =
                                        g, r = p || z; else for (O in r = p || A, M = [], g)g.hasOwnProperty(O) &&
                                    "$" !== O.charAt(0) && M.push(O);
                                    I = M.length;
                                    O = Array(I);
                                    for (k = 0; k < I; k++)if (H = g === M ? k : M[k], L = g[H], G = r(H, L, k), q[G])J
                                        = q[G], delete q[G], D[G] = J, O[k] = J; else {
                        ...
                        if (f) {
                            ...
                            if (d.multiple) {
                                ...
                                var h,
                                    l = NaN;
                                a.$watch(function () {
                                    l !== f.$viewValue || ka(h, f.$viewValue) || (
                    ...
                    return {
                        restrict: "E", priority: 100, compile: function (d, e) {
                            ...
                            return function (a, d, e) {
                                var k = d.parent(), m = k.data("$selectController") ||
